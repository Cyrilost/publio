 ...
 */
@WebServlet("/ModifCompteUtilisateur")
public class ModifCompteUtilisateur extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		Utilisateur moderateur = ejbutilisateur.load(id_mod);
		...
		request.setAttribute("moderateur" , moderateur );
		
		if (champvide == true){
			message = messagetel+"<br/>"+messageadresse;
			request.setAttribute("utilisateur", moderateur);
