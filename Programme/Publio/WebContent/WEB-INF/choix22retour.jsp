...
<div>
<form method="post" action="ValidationRetour">
<fieldset>
...
<input type="radio" name="reponse1"  value="<c:out value="true" />">Dans le même état que le jour du prêt<br/>
<input type="radio" name="reponse2"  value="<c:out value="true" />">Dans un état impardonable
</p>
<br />
</fieldset>
