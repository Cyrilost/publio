...
<div>
<form name="modifier" method="post" action="ModifCompteUtilisateur">
<fieldset>
...
name="nom" value="${utilisateur2.getNom()}" size="32" maxlength="32" disabled/>
</p>
<p>
<label for="prenom">Prenom</label>
<input type="text" id="prenom"
name="prenom" value="${utilisateur2.getPrenom()}" size="32" maxlength="32" disabled/>
</p>
<p>
<label for="adresse">Adresse</label>
<input type="text" id="adresse"
name="adresse" value="${utilisateur2.getAdresse()}" size="32" maxlength="64" disabled/>
</p>
<p>
<label for="telephone">Telephone</label> 
<input type="text" id="telephone"
name="telephone" value="${utilisateur2.getTelephone()}" size="10" maxlength="10" disabled/>
</p>
<p>
<label for="biblio">Détient une Bibliothèque</label>
<input type="text" id="biblio"
name="biblio" value="${utilisateur2.getBiblio()}" size="5" maxlength="5" disabled/>
<p>
<label for="id">Id</label>
<input type="text" id="id"
name="id" value="${utilisateur2.getIdUser()}" size="2" maxlength="2" readonly/>
</p>
</fieldset>
<fieldset>
